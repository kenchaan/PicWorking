...
*-------------------------------------------------------------------------------
*	ken_chaan	|	2018/11/16	|	PIC16F886_hardware_interrupt.c
*-------------------------------------------------------------------------------
...
void interrupt InterruptHandler( void )
{
	if( REG_READ_08( INTCON ) & 0x04 ){
		...
		HW_PORT_Set( eOUTPUT_PORT_STATUS_INT_TMR0, TRUE );
		HW_TIM_Interrupt( eTIMER_TYPE_FRAME );
		HW_PORT_Set( eOUTPUT_PORT_STATUS_INT_TMR0, FALSE );
	...
	// 	REG_CLR_08( PIR1, 0x10 );
		...
		HW_PORT_Set( eOUTPUT_PORT_STATUS_INT_SSP, TRUE );
		HW_SSP_Interrupt();
		HW_PORT_Set( eOUTPUT_PORT_STATUS_INT_SSP, FALSE );
	...
	// 	REG_CLR_08( PIR1, 0x02 );
		...
		HW_PORT_Set( eOUTPUT_PORT_STATUS_INT_TMR1, TRUE );
		HW_TIM_Interrupt( eTIMER_TYPE_TIME );
		HW_PORT_Set( eOUTPUT_PORT_STATUS_INT_TMR1, FALSE );
