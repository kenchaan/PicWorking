...
*-------------------------------------------------------------------------------
*	kenchaan	|	2019/09/09	|	PIC16F886_hardware_timer.c
*-------------------------------------------------------------------------------
...
*	static variable
*-----------------------------------------------------------------------------*/
static U32 g_u32TimeCount = 0;
static BOOL g_isEnableCount = TRUE;
...
{
	if( HW_INT_IsInterrupted( eINTERRUPT_TYPE_TMR1 ) && g_isEnableCount ){
		g_u32TimeCount++;
	}
}
...
* Return	: None
*-----------------------------------------------------------------------------*/
void HW_TIM_EnableCount( const BOOL isEnable )
{
	g_isEnableCount = isEnable;
}
