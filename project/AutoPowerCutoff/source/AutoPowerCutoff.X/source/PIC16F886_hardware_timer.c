...
*-------------------------------------------------------------------------------
*	kenchaan	|	2019/01/29	|	PIC16F886_hardware_timer.c
*-------------------------------------------------------------------------------
...
static volatile BOOL g_isEnableTimeCount = FALSE;
...
void HW_TIM_EnableTimeCount( const BOOL isEnable )
{
	if( isEnable ){
		...
		/* カウント停止 */
		REG_CLR_08( PIE1, 0x01 );
	}

	g_isEnableTimeCount = isEnable;
}
